...
try {
    ...
    // Prepare a SQL statement to select a record matching the brand name selected in the view dropdown list
...
$dbhandle = NULL;
ChromePhp::warn('modelDrinkDetails.php: echo result is frontend in JSON packet');
ChromePhp::warn($result);
